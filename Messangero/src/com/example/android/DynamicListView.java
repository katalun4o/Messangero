...
public class DynamicListView extends ListView {
	...
	private boolean mIsRearrangeEnabled = true;

    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 15;

    public ArrayList<Courier> mCheeseList; 
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        AdapterVouchers adapter = ((AdapterVouchers)getAdapter());
    ...
    public void setList(ArrayList<Courier> vouchersList) {
        mCheeseList = vouchersList;
    }


	public void setIsRearrangeEnabled(boolean mIsRearrangeEnabled) {
		this.mIsRearrangeEnabled = mIsRearrangeEnabled;
	}
